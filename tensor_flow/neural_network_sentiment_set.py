...
train_test_data = []
try:
    with open('sentiment_set.pickle', 'rb') as pickle_in:
        train_test_data = pickle.load(pickle_in)
except FileNotFoundError:
    print("\nsentiment_set.pickle not found. Please run create_sentiment_set.py first.")
    exit(0)

train_x = train_test_data[0]
train_y = train_test_data[1]
test_x = train_test_data[2]
